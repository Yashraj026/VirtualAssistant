  ...
  return (
    ...
    style={{backgroundImage:`url(${bg})`,backgroundPosition: "center"}}>
        ...
        shadow-lg shadow-black flex flex-col justify-center items-center gap-[20px] px-[20px]' onSubmit={handleSignIn}>
            <h1 className='text-white text-[30px] font-semibold mb-[30px]'>Welcome to <span
            ...
            <p className='text-white text-[18px] cursor-pointer'>Want to create a new account ? <span className='text-[#0ed3e1] cursor-pointer' onClick={()=>navigate("/signup")} >Sign Up</span></p>
        </form>
